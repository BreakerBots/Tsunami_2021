...
public class GalacticOptimal extends AutoPath {
  ...
  public void start() {
    ...
    run(new ResetOdometry(2.5, 10)); // Started at 2.5, 10
    // try 2.5, 15, -45
    ...
    if (pathChoice == 0) {
      ...
      //?
        ...
        intaked = run(new DriveTrajectoryAndPickupBall(false, MAX_VEL, MAX_ACC,
            new Position(7.5, 10, 0), // B3, last position
