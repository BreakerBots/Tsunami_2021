...
public class Flywheel extends Subsystem {
  ...
  public void update() {
    if (Superstructure.isEnabled() && Superstructure.is(FlywheelState.SPINNING)) {
      ...
      if (Constants.flywheel.OPEN_LOOP) setPercentOutput(1.0);
  ...
  public void debug() {
    ...
    Constants.flywheel.RPM_TOL =
        Tuner.getTunerInputDouble("Flywheel Tol", Constants.flywheel.RPM_TOL);
