...
public class Drive extends Subsystem {
  ...
  public void updateSim() {
    ...
    drivetrainSim.setInputs(falconL1.getMotorOutputVoltage(), falconR1.getMotorOutputVoltage());
    drivetrainSim.update(0.02);

    ((EncoderSim) leftEncoder)
        .setVelocityAccelMeters(
            drivetrainSim.getLeftPositionMeters(),
            drivetrainSim.getLeftVelocityMetersPerSecond(),
            Constants.drive.WHEEL_DIAMETER);
    ((EncoderSim) rightEncoder)
        .setVelocityAccelMeters(
  ...
  public static void set(DriveSignal signal) {
    com.team5104.frc2021.subsystems.Drive.signal = signal;
  }
  ...
  public static double[] getDriveStateMeters() {
    return new double[] {
      ...
      rightEncoder.getComponentRevs()
          * Units.feetToMeters(Constants.drive.WHEEL_DIAMETER)
          * Math.PI,
  ...
  public static void reset() {
    ...
    if (RobotState.isSimulation()) drivetrainSim.setPose(new Pose2d());
  }
  ...
  public void initSim() {
    ...
    if (!RobotState.isSimulation()) falconR1.setInverted(true);
    ...
    drivetrainSim =
        new DifferentialDrivetrainSim(
            ...
            null // VecBuilder.fill(0, 0, 0.0001, 0.1, 0.1, 0.005, 0.005) //TODO: GET ACTUAL
            // MEASUREMENT
            );
