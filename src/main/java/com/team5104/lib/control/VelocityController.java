...
public class VelocityController {
  ...
  public VelocityController(double kP, double kI, double kD, double kS, double kV, double kA) {
  ...
  public double calculate(double currentVelocity, double targetVelocity) {
    ...
    lastFFOutput = ff.calculate(targetVelocity, 0);
    lastOutput = lastFFOutput + lastPIDOutput;

    return lastOutput;
  }

  public double getLastFFOutput() {
    return lastFFOutput;
  }
