...
public class RobotState {
  ...
  public static boolean isEnabled() {
    return currentMode != RobotMode.DISABLED;
  }
  ...
  public static boolean is(RobotMode mode) {
  ...
  public static RobotMode getLastMode() {
    return lastMode;
  }
  /** @return the hertz of the loop (def 50hz) - aka 1/loopPeriod */
  public static int getLoopHz() {
    return (int) (1000.0 / getLoopPeriod());
  }
  /** @return the loop period (def 20ms) in ms - aka 1/loopHz */
  public static int getLoopPeriod() {
    return (int) loopPeriod;
  }
  /** sets the loop period in ms */
  public static void setLoopPeriod(double period) {
    loopPeriod = period;
  }
