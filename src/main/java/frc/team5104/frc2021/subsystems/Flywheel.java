...
import frc.team5104.frc2021.Superstructure.FlywheelState;
import frc.team5104.lib.*;
import frc.team5104.lib.control.VelocityController;
import frc.team5104.lib.managers.Subsystem;
import frc.team5104.lib.sensors.Encoder.FalconEncoder;
...
public class Flywheel extends Subsystem {
	...
	public static boolean isSpedUp() {
		return (motor1 == null) ? true : Util.roughlyEquals(getAvgRPM(), getTargetRPM(),
